...
def test_train():
    ...
    copy_files(
        src=os.path.join(data_path, "demo-dataset_files", "demo"),
    ...
    remove_files(src=os.path.join(data_path, "dataset_files"), extension="*.txt")

    shutil.rmtree(
        os.path.join(paths.get_models_dir(), out["modelname"]), ignore_errors=True
    )
...
def test_curl_train():
    ...
    copy_files(
        src=os.path.join(data_path, "demo-dataset_files"),
        dst=os.path.join(data_path, "dataset_files"),
        extension="*.txt",
    )
